...
data1 <- read_csv(here('Data folder', 'df_edited_R.csv'))
...
model.lm <- lm(defence_def_rtg ~ player_type+Calc_B+Blk.+stl_per_poss+def_rtg+trb_pct
               +Class_n1+Team_AdjEM_dif+KP_Conf_Dif+dws+Ht+DR., data = train)

#player_type+games_started+fg3_pct+ft_pct+sos+fg_per_poss+ft_per_poss+trb_per_poss+ast_per_poss+pts_per_poss+ast_pct+obpm+dbpm+bpm+Ht+Calc_A2+Calc_A3+Calc_C+Class_n1+Year_dif+Team_AdjEM_dif+KP_Conf_Dif
